        ...
        <div class="sm:px-6 lg:px-8">
            <div class="bg-gray-100 dark:bg-gray-900 overflow-hidden shadow-sm sm:rounded-lg p-6">
                <div class="flex justify-between items-center">
                    ...
                    <div>
                        <x-btn-red-link href="{{ route('clients.index') }}">
                    ...
                    <form action="{{ route('clients.update', $item->id) }}" method="post">
                        ...
                        <div class="mb-5">
                            ...
                            <x-text-input id="fax" name="fax" type="text" class="mt-1 block w-full"
                                autofocus autocomplete="fax" value="{{ old('fax', $item->fax) }}" />
                        ...
                        <div class="mb-5">
                            ...
                            <x-text-input id="trn" name="trn" type="text" class="mt-1 block w-full"
                                autofocus autocomplete="trn" value="{{ old('trn', $item->trn) }}" />
