            ...
            <form method="post" action="{{ route('profile.update') }}" class="space-y-6">
                ...
                <div class="md:grid grid-cols-4 gap-8">
                    <div class="col-span-2">
                        <div
                            class="bg-gray-100 dark:bg-gray-900 overflow-hidden shadow-sm sm:rounded-lg p-6 md:p-12 space-y-6">
                            <div>
                    ...
                    <div class="col-span-2">
                        <div
                            ...
                            <div class="mb-5 relative">
                                ...
                                <x-date-input id="join_date" name="join_date" type="text" class="mt-1 block w-full"
                                    required autofocus autocomplete="join_date"
                ...
                <div class="bg-gray-100 dark:bg-gray-900 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 md:px-12 py-6 text-white">
