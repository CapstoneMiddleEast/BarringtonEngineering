        ...
        <div class="sm:px-6 lg:px-8">
            <div class="bg-gray-100 dark:bg-gray-900 overflow-hidden shadow-sm sm:rounded-lg p-6">
                <div class="flex justify-between items-center">
                    ...
                    <div>
                        <x-btn-red-link href="{{ route('profile.edit') }}">
                            Edit Profile</x-btn-red-link>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="pb-6">
        <div class="sm:px-6 lg:px-8">
            <div class="md:grid grid-cols-5 gap-8">
                <div class="text-white col-span-2 mb-6 md:mb-0">
                    <div class="bg-gray-100 dark:bg-gray-900 overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <div class="bg-gray-100 dark:bg-gray-900 overflow-hidden shadow-sm sm:rounded-lg p-6">
                        <dl class="text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                            ...
                            <div class="flex flex-col py-3">
                                ...
                                <dd class="text-base font-semibold">{{ formatted_date($user->join_date) }}</dd>
                            </div>
                            <div class="flex flex-col py-3">
            ...
            <div class="bg-gray-100 dark:bg-gray-900 overflow-hidden shadow-sm sm:rounded-lg p-6 mt-6">
                <h2 class="text-xl font-bold dark:text-white text-gray-900 mb-3">
                    {{ __('Delete Account') }}
                </h2>

                <p class="mt-1 dark:text-white text-gray-900 text">
                    {{ __('Once your account is deleted, all of its resources and data will be permanently deleted. Before deleting your account, please download any data or information that you wish to retain.') }}
                    <x-link href="{{ route('profile.delete') }}">Delete</x-link>
                </p>
            </div>
        </div>
    </div>
