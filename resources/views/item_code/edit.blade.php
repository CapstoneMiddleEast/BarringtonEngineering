        ...
        <div class="sm:px-6 lg:px-8">
            <div class="bg-gray-100 dark:bg-gray-900 overflow-hidden shadow-sm sm:rounded-lg p-6">
                <div class="flex justify-between items-center">
                    ...
                    <div>
                        <x-btn-red-link href="{{ route('item_codes.index') }}">
        ...
        <div class="sm:px-6 lg:px-8">
            <div class="bg-gray-100 dark:bg-gray-900 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 text-white">
                    <form action="{{ route('item_codes.update', $item->id) }}" method="post">
                        @csrf
                        <div class="mb-5">
                        ...
                        <div class="mb-5">
                            ...
                            <x-text-area id="description" name="description" class="mt-1 block w-full" rows="2"
                                autofocus
                                autocomplete="description">{{ old('description', $item->description) }}</x-text-area>
