            ...
            <div class="bg-gray-900 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 text-white">
                    <h2 class="text-xl font-bold dark:text-white text-gray-900 mb-3">
                        {{ __('Are you sure you want to delete this sales enquiry?') }}
                    </h2>
                    ...
                    <div class="flex justify-between items-center mt-8">
                        <div>
                            <x-btn-red-link href="{{ route('sales_enquiries.index') }}">
                        ...
                        <form action="{{ route('sales_enquiries.destroy', $item->id) }}" method="post">
                            @csrf
