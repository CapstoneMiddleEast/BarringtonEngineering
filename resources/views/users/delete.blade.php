            ...
            <div class="bg-gray-900 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 text-white">
                    ...
                    <p class="mt-1 dark:text-white text-gray-900 text-sm">
                        {{ __('The deletion of the account will result in the permanent deletion of all its resources and data. Please confirm you would like to permanently delete the account.') }}
                    </p>
